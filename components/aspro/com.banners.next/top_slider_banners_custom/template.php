		...
		<div class="flexslider">
			<ul class="slides">
				<?foreach($arResult["ITEMS"] as $arItem):?>
					...
					if (!empty($arItem["PROPERTIES"]["PICTURE_SVG"]['VALUE'])) {
					    $background = CFile::GetPath($arItem["PROPERTIES"]["PICTURE_SVG"]['VALUE']);
                    }

					?>

					<li class="box<?=($arItem["PROPERTIES"]["TEXTCOLOR"]["VALUE_XML_ID"] ? " ".$arItem["PROPERTIES"]["TEXTCOLOR"]["VALUE_XML_ID"] : "");?><?=($arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] ? " ".$arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] : " left");?>" data-nav_color="<?=($arItem["PROPERTIES"]["NAV_COLOR"]["VALUE_XML_ID"] ? $arItem["PROPERTIES"]["NAV_COLOR"]["VALUE_XML_ID"] : "");?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>"
                        style="background-image: url('<?=$background?>') !important;">
...
<style>
	.top_slider_wrapp, .top_slider_wrapp .flexslider, .top_slider_wrapp .flex-viewport, .top_slider_wrapp .flex-viewport li {
		height: <?=$bannerHeight?>px !important;
	}
	.top_slider_wrapp .flex-viewport li{
